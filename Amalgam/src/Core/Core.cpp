...
static inline bool CheckDXLevel()
{
	...
	if (mat_dxlevel->GetInt() < 90)
	{
		...
		SDK::Output("Pissgram", sMessage, Vars::Menu::Theme::Accent.Value, OUTPUT_CONSOLE | OUTPUT_DEBUG | OUTPUT_TOAST | OUTPUT_MENU);
		//return false;
	}
...
void CCore::Load()
{
	...
	SDK::Output("Pissgram", "Loaded", Vars::Menu::Theme::Accent.Value, OUTPUT_CONSOLE | OUTPUT_DEBUG | OUTPUT_TOAST | OUTPUT_MENU);
}
...
void CCore::Unload()
{
	...
	SDK::Output("Pissgram", "Unloaded", Vars::Menu::Theme::Accent.Value, OUTPUT_CONSOLE | OUTPUT_DEBUG);
}