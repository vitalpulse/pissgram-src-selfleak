...
Enum(BacktrackGlow, Last = 1 << 0, First = 1 << 1, Always = 1 << 2, IgnoreZ = 1 << 3)
Enum(ESPOptions, NameUseGroupColor = 1 << 0, DynamicBars = 1 << 1, TagsDisplayBottom = 1 << 2, TagsOverrideColor = 1 << 3, CenteredHealthText = 1 << 4)
...
struct Group_t
{
	...
	bool m_bOffscreenArcs = false;
	int m_iOffscreenArrowsOffset = 325.f;
	float m_flOffscreenArrowsMaxDistance = 700.f;
	float m_flOffscreenArrowsMinSize = 20.f;
	float m_flOffscreenArrowsMaxSize = 30.f;
	float m_flOffscreenArrowsFlickerDistance = 400.f;
