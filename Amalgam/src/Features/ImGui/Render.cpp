...
void CRender::LoadFonts()
{
	...
	FontSmall = io.Fonts->AddFontFromFileTTF(R"(C:\Windows\Fonts\arial.ttf)", H::Draw.Scale(11), &fontConfig, fontRange);
	FontRegular = io.Fonts->AddFontFromFileTTF(R"(C:\Windows\Fonts\arial.ttf)", H::Draw.Scale(13), &fontConfig, fontRange);
	FontBold = io.Fonts->AddFontFromFileTTF(R"(C:\Windows\Fonts\arialbd.ttf)", H::Draw.Scale(13), &fontConfig, fontRange);
	FontLarge = io.Fonts->AddFontFromFileTTF(R"(C:\Windows\Fonts\arial.ttf)", H::Draw.Scale(14), &fontConfig, fontRange);
	FontMono = io.Fonts->AddFontFromFileTTF(R"(C:\Windows\Fonts\cour.ttf)", H::Draw.Scale(15), &fontConfig, fontRange); // windows mono font installed by default
#else
