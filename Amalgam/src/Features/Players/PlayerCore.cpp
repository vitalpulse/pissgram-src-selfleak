...
void CPlayerlistCore::SavePlayerlist()
{
	...
	try
	{
		...
		SDK::Output("Pissgram", "Saved playerlist", Vars::Menu::Theme::Accent.Value, OUTPUT_CONSOLE | OUTPUT_DEBUG | OUTPUT_TOAST | OUTPUT_MENU);
	}
	catch (...)
	{
		SDK::Output("Pissgram", "Save playerlist failed", Vars::Menu::Theme::Accent.Value, OUTPUT_CONSOLE | OUTPUT_DEBUG);
	}
}
...
void CPlayerlistCore::LoadPlayerlist()
{
	...
	try
	{
		...
		F::PlayerUtils.m_bLoad = false;
		SDK::Output("Pissgram", "Loaded playerlist", Vars::Menu::Theme::Accent.Value, OUTPUT_CONSOLE | OUTPUT_DEBUG | OUTPUT_TOAST | OUTPUT_MENU);
	}
	catch (...)
	{
		SDK::Output("Pissgram", "Load playerlist failed", Vars::Menu::Theme::Accent.Value, OUTPUT_CONSOLE | OUTPUT_DEBUG);
	}
}